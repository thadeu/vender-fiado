...
class AddReleaseScreen extends React.Component {
  ...
  render() {
    const enum_status = ['Aguardando Pagamento', 'Pagamento Recebido']
        ...
        <View>
          ...
          <InputContainer>
            ...
            <InputPhone
              ...
              onChangeText={phone_number => this.setState({ phone_number: phone_number.replace(/\D/ig, '') })}
            />
          </InputContainer>
          ...
          <SaveButton 
            ...
            <View>
              <Text style={{ color: 'white', fontWeight: '600' }}>
                {this.props.isLoading ? 'Salvando...' : 'Adicionar Venda'}
              </Text>
            </View>
          </SaveButton>
        </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(AddReleaseScreen)